...
public interface Constants {
	...
	int DEPARTURE_TRACKS_NUMBER = 6;   //4
	...
	double OUTBOUND_TRAIN_INTERVAL = 8*1.0f/60;   //單位:小時
	/*
	 * case 5
	 */
/*	int RECEIVING_TRACKS_NUMBER = 10;
	...
	int MAX_OUTBOUND_TRAIN_NUMBER = 150;
	int MIN_OUTBOUND_TRAIN_NUMBER = 25;
	double HUMP_RATE = (1*1.0f/2.2)/60;   // 每拉一台車，單位:小時
	double HUMP_INTERVAL = 10*1.0f/60; //單位:小時
